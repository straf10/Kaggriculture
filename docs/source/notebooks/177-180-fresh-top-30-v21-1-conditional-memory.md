...
> Extracted by `analysis/nb_extract.py` from `notebooks/177-180-fresh-top-30-v21-1-conditional-memory.ipynb`.
...
```text
[92m04:29:11 - LiteLLM:WARNING[0m: get_model_cost_map.py:271 - LiteLLM: Failed to fetch remote model cost map from https://raw.githubusercontent.com/BerriAI/litellm/main/model_prices_and_context_window.json: [Errno -3] Temporary failure in name resolution. Falling back to local backup.
```
...
{'policy': 'v21.1_conditional_top30_memory', 'title_metric': '177/180 frozen current-Top-30 replay holdout; not an official LB score', 'main_py': '/kaggle/working/main.py', 'main_bytes': 428598, 'main_sha256': 'd9dc24ce5429ec628ead0621a160bee90725350683d7dfcc4686fcaf511f3aab', 'runtime_route_memories': 30, 'submission': '/kaggle/working/submission.tar.gz', 'exact_self_play_smoke': [{'seed': 21260806, 'status': ['DONE', 'DONE'], 'rewards': [67.0, 67.0]}, {'seed': 21260807, 'status': ['DONE', 'DONE'], 'rewards': [58.0, 58.0]}], 'ready': True}
```

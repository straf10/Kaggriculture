...
| ⚠️ A frozen route decays fast, measured on someone else | **Peter Parker — the *pure* frozen tape cited on 08-17 as evidence that open-loop holds up — fell #29 / 2.844,2 → #383 / 2.364,7 in ~23 hours.** Our own donor slipped 3.004,6 → 2.985,6 while frozen since 08-14. §4.4#1 is not a theoretical risk for `55586926`: it is a frozen route with **~6 weeks to the deadline** | `leaderboard -d`, 08-17 vs 08-18 |

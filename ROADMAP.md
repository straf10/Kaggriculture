...
| 🟢 Our best public score | **1.736,0** — `55586926`, the **ReCurSiON majority-vote reconstruction**, read 2026-08-17 **23:15 UTC on 15 episodes**, 46 minutes after upload. **A new repo best**, past the evicted Valmorlee tape's converged 1.599,1 and our previous best 1.617,6 | `kaggle competitions submissions -v` |
| Our active submissions | 🔄 **`55586926` ReCurSiON reconstruction — 600,0 → 1.125,9 (7 eps, 22:51) → 1.736,0 (15 eps, 23:15)**, still climbing at **~20 episodes/hour** (DEV +$15.276 / unpinned holdout +$12.212 IMPROVED vs the raw Valmorlee tape) · **`55575305` Ueddy T2 tape — 1.375,9 on 72 episodes** · `55548339` Valmorlee T1 tape — **1.599,1 on 111 episodes, now INACTIVE** (evicted by date per the user's decision — only the latest two count) | `kaggle competitions submissions` · `episodes <id> -v` |
